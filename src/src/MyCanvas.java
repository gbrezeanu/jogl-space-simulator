...
public class MyCanvas extends GLCanvas implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        String textureFile = "/home/f0rest/IdeaProjects/GUI-solar-system/earthmap1k.jpg";
        earthTexture = getObjectTexture(gl, textureFile);

        textureFile = "/home/f0rest/IdeaProjects/GUI-solar-system/solar_panel_256x32.png";
        solarPanelTexture = getObjectTexture(gl, textureFile);


        textureFile = "/home/f0rest/IdeaProjects/GUI-solar-system/preview_sun.jpg";
        this.sun = new Sun(gl, glu, getObjectTexture(gl, textureFile));

        textureFile = "/home/f0rest/IdeaProjects/GUI-solar-system/mercurymap.jpg";
        Planet mercury = new Planet(gl,glu, getObjectTexture(gl, textureFile), 1.2f, SUN_RADIUS + 2f , 2.56f);

        textureFile = "/home/f0rest/IdeaProjects/GUI-solar-system/venusmap.jpg";
        Planet venus = new Planet(gl,glu, getObjectTexture(gl, textureFile), 0.7f, SUN_RADIUS + 16f , 3.56f);

        textureFile = "/home/f0rest/IdeaProjects/GUI-solar-system/mars_1k_color.jpg";
